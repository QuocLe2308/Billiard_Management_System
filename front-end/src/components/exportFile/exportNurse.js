...
const ExportFileNurse = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/nurse/export", {
    ...
    link.href = url;
    link.setAttribute("download", "ListNurse.xlsx");
...
export default ExportFileNurse;
