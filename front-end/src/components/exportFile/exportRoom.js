...
const ExportFileRoom = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/room/export", {
    ...
    link.href = url;
    link.setAttribute("download", "ListRoom.xlsx");
