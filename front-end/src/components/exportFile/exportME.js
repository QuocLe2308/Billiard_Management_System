...
const ExportFileMe = async () => {
  try {
    const response = await axios.get("http://localhost:8080/api/me/export", {
    ...
    link.href = url;
    link.setAttribute("download", "medicalexamination.xlsx");
