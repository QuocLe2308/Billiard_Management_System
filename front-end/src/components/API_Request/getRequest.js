...
// Tạo instance axios với cấu hình cho phép gửi cookie
const api = axios.create({
  baseURL: API_BASE_URL + ":5014", // Đặt base URL cho tất cả yêu cầu
  withCredentials: true, // Cho phép gửi thông tin xác thực
});
...
const getRequest = async (url, params = {}) => {
  try {
    const response = await api.get(url, { params }); // Thêm params nếu có
